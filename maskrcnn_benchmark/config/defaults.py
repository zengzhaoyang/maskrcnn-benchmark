...
_C.MODEL.SEMANTIC_ON = False
_C.MODEL.IOU_ON = False
...
# Semantic
_C.MODEL.ROI_BOX_HEAD.SEMANTIC_POOLER_SCALES = (1.0 / 8, )
...
_C.MODEL.ROI_MASK_HEAD.INTERLEAVED_EXECUTION = False
_C.MODEL.ROI_MASK_HEAD.INFORMATION_FLOW = False
# Semantic
_C.MODEL.ROI_MASK_HEAD.SEMANTIC_POOLER_SCALES = (1.0 / 8, )
...
_C.MODEL.SEMANTIC_HEAD = CN()
_C.MODEL.SEMANTIC_HEAD.CONV_CHANNELS = 256
_C.MODEL.SEMANTIC_HEAD.NUM_STACKED_CONVS = 4
_C.MODEL.SEMANTIC_HEAD.USE_GN = False
_C.MODEL.SEMANTIC_HEAD.DILATION = 1
_C.MODEL.SEMANTIC_HEAD.NUM_INS = 5
_C.MODEL.SEMANTIC_HEAD.FUSION_LEVEL = 1
_C.MODEL.SEMANTIC_HEAD.NUM_CLASSES = 183

_C.MODEL.ROI_IOU_HEAD = CN()
_C.MODEL.ROI_IOU_HEAD.FG_IOU_THRESHOLD = 0.5
_C.MODEL.ROI_IOU_HEAD.BG_IOU_THRESHOLD = 0.5
_C.MODEL.ROI_IOU_HEAD.BATCH_SIZE_PER_IMAGE = 512
