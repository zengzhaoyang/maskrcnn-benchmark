...
from ..roi_heads.roi_heads import build_vg_roi_heads


class VGRCNN(nn.Module):
    """
    ...
    def __init__(self, cfg):
        super(VGRCNN, self).__init__()

        self.backbone = build_backbone(cfg)
        self.rpn = build_rpn(cfg, self.backbone.out_channels)
        self.roi_heads = build_vg_roi_heads(cfg, self.backbone.out_channels)
